...
const (
	GreeterService_SayHello_FullMethodName = "/echo.v4.GreeterService/SayHello"
	GreeterService_GetHello_FullMethodName = "/echo.v4.GreeterService/GetHello"
)
...
type GreeterServiceClient interface {
	...
	GetHello(ctx context.Context, in *GreeterServiceSayHelloRequest, opts ...grpc.CallOption) (*GreeterServiceSayHelloResponse, error)
}
...
func (c *greeterServiceClient) GetHello(ctx context.Context, in *GreeterServiceSayHelloRequest, opts ...grpc.CallOption) (*GreeterServiceSayHelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GreeterServiceSayHelloResponse)
	err := c.cc.Invoke(ctx, GreeterService_GetHello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServiceServer interface {
	...
	GetHello(context.Context, *GreeterServiceSayHelloRequest) (*GreeterServiceSayHelloResponse, error)
...
func (UnimplementedGreeterServiceServer) GetHello(context.Context, *GreeterServiceSayHelloRequest) (*GreeterServiceSayHelloResponse, error) {
...
func _GreeterService_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreeterServiceSayHelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServiceServer).GetHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GreeterService_GetHello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServiceServer).GetHello(ctx, req.(*GreeterServiceSayHelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "echo.v4.GreeterService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetHello",
			Handler:    _GreeterService_GetHello_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "echo/v4/echo.proto",
}
