...
const (
	Echo_EchoMessage_FullMethodName                = "/echo.v3.Echo/EchoMessage"
	Echo_UnaryEcho_FullMethodName                  = "/echo.v3.Echo/UnaryEcho"
	Echo_ServerStreamingEcho_FullMethodName        = "/echo.v3.Echo/ServerStreamingEcho"
	Echo_ClientStreamingEcho_FullMethodName        = "/echo.v3.Echo/ClientStreamingEcho"
	Echo_BidirectionalStreamingEcho_FullMethodName = "/echo.v3.Echo/BidirectionalStreamingEcho"
)
...
func (c *echoClient) EchoMessage(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Echo_EchoMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEchoServer) EchoMessage(context.Context, *EchoRequest) (*EchoResponse, error) {
...
func _Echo_EchoMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Echo_EchoMessage_FullMethodName,
	}
